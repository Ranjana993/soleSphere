        ...
        <div className='mx-auto'>
            <div className='flex justify-around items-center flex-row mx-4 mt-4 -mb-4'>
                <div className='mt-6 flex flex-wrap gap-4 justify-center my-4'>
                    <Link to="#" className='bg-black text-white px-4 py-1 rounded-lg cursor-pointer hover:bg-gray-900' onClick={() => handleCategoryFilter("all")}>All</Link>
                    <Link to="#" className='bg-black text-white px-4 py-1 rounded-lg cursor-pointer hover:bg-gray-900' onClick={() => handleCategoryFilter("menwear")}>Men Wear</Link>
