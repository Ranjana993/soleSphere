        ...
        <div className='mx-auto'>
            <div className='flex justify-start lg:justify-around px-0 lg:px-3 items-center flex-wrap flex-col lg:flex-row mt-4 mb-4'>
                <div className='mt-6 flex flex-wrap gap-2 lg:gap-4 justify-center items-center my-6 px-2'>
                    <Link to="#" className='bg-black text-white text-sm md:text-xl lg:text-[18px] px-1 md:px-2 lg:px-4 py-1 rounded-lg cursor-pointer hover:bg-orange-700' onClick={() => handleCategoryFilter("all")}>All</Link>
                    <Link to="#" className='bg-black text-white text-sm md:text-xl lg:text-[18px] px-4 py-1 rounded-lg cursor-pointer hover:bg-teal-900' onClick={() => handleCategoryFilter("menwear")}>Men Wear</Link>
