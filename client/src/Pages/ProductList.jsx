                    ...
                    <div className='flex gap-2 m-auto flex-wrap items-center justify-center'>
                        {
                            filteredData.map(item => (
                                <h2 key={item._id}>
                                    <div key={item.id} className="relative m-10 border border-gray-300 flex w-full max-w-xs flex-col overflow-hidden rounded-sm  shadow-xl hover:shadow-gray-500 bg-white" >
                                        <Link>
                                            ...
                                            <div className="mt-4 px-5 pb-5">
                                                ...
                                                <div className="mt-2 mb-5 flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="mr-2 ml-3 rounded bg-orange-400 px-2.5 py-0.5 text-xs font-semibold">5.0</span>
                                                    </div>
                                                </div>
                                                <Link to={"/product-detail"} className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-teal-950 focus:outline-none focus:ring-4 focus:ring-blue-300">
