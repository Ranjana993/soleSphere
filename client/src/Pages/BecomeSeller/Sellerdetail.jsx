...
const Sellerdetail = () => {
  return (
    <div className="py-12">
      <div>
        <h1 className="text-center font-playfair-display font-noto-serif text-4xl lg:text-5xl capitalize py-3 my-12">Do you want to become a seller ??</h1>
      ...
      <section className="text-center px-12 mt-12">
      ...
      <div className="mt-16">
        <section className="flex px-12 justify-between gap-6">
          <div className="w-[50%] mt-12">
            <h4 className="text-5xl font-noto-serif py-4 text-rose-600">Sliders</h4>
            <p className="pr-12 text-gray-700">Sliding into someone&apos;s DM might be inappropriate and we girls do hate unwanted attention most of the time! But the mere thought of your feet sliding into fashion footwear like the oh-so comfortablesliders makes you want to daydream a bit longer.</p>
          </div>
          <div className="w-[50%]">
        ...
        <section className="flex px-12 justify-between gap-6">
          ...
          <div className="w-[50%] mt-12">
            ...
            <p className="pr-12 text-gray-700">Our first pick when it’s raining footwear sale online, chappal sare
        ...
        <section className="flex px-12 justify-between gap-6">
          <div className="w-[50%] mt-12">
            ...
            <p className="pr-12 text-gray-700">Sandalsare our best friends forever, and ever. You want to go for a formal look?
