  ...
  return (
    <div className="">
      <div className="flex justify-around items-center py-4 lg:py-6">
        ...
        <div onClick={() => navigate("/add-product")} className="w-[40%] lg:w-[30%] flex justify-end pr-2">
          <button className="bg-green-600 px-4 lg:px-8 py-2 text-white flex items-center rounded-full">
